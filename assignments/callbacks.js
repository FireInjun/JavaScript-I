...
} /* STRETCH PROBLEM */ /* STRETCH PROBLEM */ /* STRETCH PROBLEM */ /* STRETCH PROBLEM */ /* STRETCH PROBLEM */ // removeDuplicates removes all duplicate values from the given array. // Pass the duplicate free array to the callback function.
...
/* STRETCH PROBLEM */ // Do not mutate the original array.
...
function removeDuplicates(array, cb) {
  ...
  let b2 =
    ...
    crayonDifference(array, cleanArray) +
    "]duplicates!";
  let c =
    "After sorting them all out, which took a long time, mind you, there are only: [" +
    cleanArray.length +
    "] unique entries!";
